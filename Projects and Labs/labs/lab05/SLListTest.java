...
public class SLListTest {
    ...
    public void testSLListReverse() {
        ...
        s2.reverse();
        SLList expected2 = SLList.of(5, 4, 3, 2, 1);
        assertEquals(s2, expected2);

        SLList s3 = SLList.of(1, 2, 3, 4, 5, 6);
        s3.reverse();
        SLList expected3 = SLList.of(6, 5, 4, 3, 2, 1);
        assertEquals(s3, expected3);
    }
}
